 ...
 * well.
 */
public class LoginActivity extends Activity implements NetworkListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if(getIntent() != null){
	    	String status = getIntent().getStringExtra("logout");
	    	if(status != null && status.equals("true")){
	    		mEmail = null;
	    		mPassword = null;
	    		Intent i = new Intent(this,Campus_MapActivity.class);
				startActivity(i);
	    	}
	    }
	...
	public void networkRequestCompleted(HTTPRequestResult r) {
		...
		try {
			...
			if(item.getInt("status") == 0){
				...
				Intent i = new Intent(this,TribeSignalActivity.class);
				Bundle extras = new Bundle();
		    	extras.putString("username", HTTPBasicAuth.getInstance().getUsername());
		    	extras.putString("password", HTTPBasicAuth.getInstance().getPassword());
		    	Log.i("LoginActivity",mEmail);
		    	i.putExtras(extras);
				startActivity(i);
			}
		} catch (Exception e){
